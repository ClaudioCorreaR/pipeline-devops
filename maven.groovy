...
def call(){
  ...
  stage("Paso 4: Sonar - Análisis Estático"){
      ...
      withSonarQubeEnv('sonarqube') {
          sh 'mvn clean verify sonar:sonar -Dsonar.projectKey=maven-gradle -Dsonar.host.url=http://sonarqube:9000 -Dsonar.login=9d886284c574229ebc1bf5b9051c6dbbd8063e16 -Dsonar.java.binaries=build'
      }
  }
